...
const consultants: Consultant[] = [
  ...
  { id: "7", name: "Drew Cano", username: "@drew", status: "Active", role: "UX Copywriter", email: "drew@untitledui.com" },
  { id: "8", name: "Orlando Diggs", username: "@orlando", status: "Active", role: "UI Designer", email: "orlando@untitledui.com" },
  { id: "9", name: "Andi Lane", username: "@andi", status: "Active", role: "Product Manager", email: "andi@untitledui.com" },
  { id: "10", name: "Kate Morrison", username: "@kate", status: "Active", role: "QA Engineer", email: "kate@untitledui.com" },
];
